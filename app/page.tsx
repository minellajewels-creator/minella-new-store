...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Is Minella Jewels jewellery waterproof?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. All Minella Jewels pieces are 100% waterproof and sweat-resistant. You can wear them in rain, while exercising, or in the shower.' } },
...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <button className="hero-cta" onClick={undefined}
            // scroll handled client-side below
          >
            Shop Now &rarr;
          </button>
        </div>
      ...
      {/* Hero scroll button needs to be client — inline script is fine here */}
      ...
      {/* Product grid with realtime Firestore */}
