...
// Fully dynamic — no static pre-rendering that needs Firebase at build time
...
export default async function ProductPage({
  ...
  const productJsonLd = {
    ...
    description:
      p.description ||
      `${p.title} — Anti-tarnish, water-resistant jewellery by Minella Jewels.`,
    image: allImgs,
    ...
    offers: {
      ...
      description:
        p.description ||
        `${p.title} — Anti-tarnish, waterproof, 18K gold plated jewellery by Minella Jewels.`,

      shippingDetails: {
        "@type": "OfferShippingDetails",
        shippingRate: {
          "@type": "MonetaryAmount",
          value: p.price >= 999 ? "0" : "60",
          currency: "INR",
        },
        shippingDestination: {
          "@type": "DefinedRegion",
